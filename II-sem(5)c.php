	...
	<form action="#" method="post" enctype="multipart/form-data">
		<div class="row">
	  	<div class="leftcolumn">
		    <div class="card">
		    	<div class="formheading mb-2">people's Bank (Credit Amount) </div>
		    	<table border="1">
		    		<tr>
...
if (!$qry) {
	...
	$qry1 = mysqli_fetch_array($qry, MYSQLI_ASSOC);
		$upqry = mysqli_query($con,"UPDATE `bank` SET `balance`=".($qry1['balance']+$_POST['amt'])." WHERE accno =".$_POST['acno'])or die(mysqli_error($con));
		if($upqry){
